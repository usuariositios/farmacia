...
function ($scope, Data,$location,$window,DataCont,$q) {
    ...
    $scope.verFactura_action = function(s){
        console.log(s);
        $window.open("/FARMACIA_REPORTES/factura/reporteFacturaPdf.jsp?codSalidaVenta="+s.codSalidaVenta +"&codFacturaEmitida="+s.codFacturaEmitida+"&montoTotal="+s.montoTotal+"&codEmpresa="+$scope.usuarioPersonal.empresas.codEmpresa);
    };
