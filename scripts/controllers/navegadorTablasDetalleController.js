...
app.controller('navegadorTablasDetalleController',
    ...
    $scope.verReporteTabla_action = function(pr){
        ...
        $window.open(pathFarmaciaReportes+"/tablaDetalle/reporteTabla.jsp?codTabla="+pr.codTabla +"&nombreTabla="+pr.nombreTabla+"&codEmpresa="+$scope.usuarioPersonal.empresas.codEmpresa);
    };
