...
{
app.controller('reporteVentasConsolidProdGrupoController',
...
function ($scope, Data, $location,$window) {
    ...
    $scope.verReporteSeleccionados_action = function(m){
        ...
        $window.open(pathFarmaciaReportes+"/ventasConsolidadoGrupo/reporteVentasConsolidadoGrupo.jsp?codProducto="+productos +"&fechaInicio="+$scope.datosReporte.fechaInicio +"&fechaFinal="+$scope.datosReporte.fechaFinal+"&codAlmacenVenta="+$scope.datosReporte.codAlmacenVenta+"&codEmpresa="+$scope.usuarioPersonal.empresas.codEmpresa);
    };
