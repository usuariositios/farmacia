...
app.controller('navegadorFacturasEmitidasController',
    ...
    $scope.verFactura_action = function(s){
        console.log(s);
        $window.open(pathFarmaciaReportes+"/factura/reporteFacturaPdf.jsp?codSalidaVenta="+s.salidasVenta.codSalidaVenta +"&codFacturaEmitida="+s.codFacturaEmitida+"&montoTotal="+s.montoTotal);
    };
