...
{
app.controller('editarFacturaController',
...
function ($scope, Data,$location,$window) {    
    ...
    $scope.facturaEmitidaEditar =JSON.parse(sessionStorage.getItem("facturaEmitidaEditar"));
    $scope.salidasVenta.clientes.nitCliente = $scope.facturaEmitidaEditar.nitCliente;
    ...
    $scope.guardarAgregarProducto_action = function(){
        ...
        //buscar y reemplazar el producto si existe
    ...
    $scope.guardarSalidaVenta_action = function(){            
            ...
            $scope.facturaEmitidaEditar.montoTotal = $scope.salidasVentaTotal.montoTotal;
            $scope.facturaEmitidaEditar.nitCliente = $scope.salidasVenta.clientes.nitCliente;
            
            
            
            $scope.salidasVentaBusiness.salidasVenta = angular.copy($scope.salidasVenta);
            $scope.salidasVentaBusiness.salidasVentaDetalleList = angular.copy($scope.salidasVentaDetalleList);
            $scope.salidasVentaBusiness.facturasEmitidas = angular.copy($scope.facturaEmitidaEditar);
            
            console.log($scope.salidasVentaBusiness);
            
            
            Data.post("/facturasEmitidas/editarFacturaEmitidaBusiness", $scope.salidasVentaBusiness).then(function(data){
                //window.location = "navegadorSalidasVenta.html";
                $location.path("navegadorFacturasEmitidas");
            });
    };
